...
- [x] Update DNS away from Blogger/Google and toward GitHub Pages.
...
- [x] Confirm DNS propagation at Hover/GitHub edge.
- [x] Check the live custom domain over HTTP.
- [ ] Wait for GitHub Pages certificate issuance.
- [ ] Enable GitHub Pages HTTPS enforcement once GitHub allows it.
- [ ] Check the live custom domain over HTTPS.
